package com.msc.display 
{
	...
	/**
	 * Scale9GridBitmap 类通过对 Bitmap 类的 width、height、scale9Grid 三个属性的重写来完成位图的九宫格缩放。
	 * 
	 * <p>[声明]原作者为：itamt[at]qq.com。源码地址为：http://code.google.com/p/tcodes/source/browse/trunk/src/msc/display/Scale9GridBitmap.as</p>
	 * 
	 * <p>
	 * PH修改：
