package com.pcup.utils
{
	 ...
	 * 按中文字符的拼音字母排序。
	 * 
	 * <p>[声明]：本模块不是PH所编写。原作者发布地址：http://hi.baidu.com/artgou/blog/item/eb5c2af0b0822fd37931aabd.html</p>
	 * 
	 * @example	
下面是原作者的示例：
<listing version="3.0">
	...
	*/
	public class Chinese
	{
		...
		*/  
		...
		/**
		* 获取一个中文字符的拼音首字母。
		* @param	chineseChar	中文字符（如果是字符串则只有第一个字符有效）。
		* @return	拼音首字母。
		*/  
		...
		/**
		* 指定的字符是否为中文。
		* @param	chineseChar	字符（如果是字符串则只有第一个字符有效）。
		* @return	是否是中文。
		*/  
