...
package com.sociodox.utils
{
	...
	/**
	 * Base64 类可以把二进制数据转换为Base64编码格式的字符串，也可以把经过Base64编码的字符串解码为二进制数据。
	 * 
	 * <p>[声明]原作者为：http://www.sociodox.com/。源码地址为：http://www.sociodox.com/base64.html</p>
	 * 
	 * @example	
下面是原作者写的示例。
<listing version="3.0">
////////////////////////////////////////////////////////////////////////
// Simple test: BitmapData Encoding
// 
...
//Show on screen
var vMyBitmap:Bitmap = new Bitmap(vBitmapDataToRead);
addChild(vMyBitmap);
</listing>
	 * 
	 * @author http://www.sociodox.com/
	 */
	public class Base64
	{
